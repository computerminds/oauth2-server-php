...
class AuthorizeController extends BaseAuthorizeController implements AuthorizeControllerInterface
{
     ...
     * @var mixed
     */
    protected $code_challenge; //[pkce]
    /**
     * @var mixed
     */
    protected $code_challenge_method;  //[pkce]
    ...
    public function validateAuthorizeRequest(RequestInterface $request, ResponseInterface $response)
    {
        ...
        $code_challenge = $request->query('code_challenge');  //[pkce]
        ...
        if ($this->config['enforce_pkce']) {
            ...
            if (preg_match('/^[A-Za-z0-9-._~=]{43,128}$/', $code_challenge) !== 1) {  //dgy : added '='
